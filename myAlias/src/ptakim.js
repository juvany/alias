...
const PT = {
  he: {
    ...
    ptakimTitle: 'פתקים',
    ptakimSubtitle: 'כתבו שמות ונחשו ב-3 סיבובים',
    createGame: 'פתיחת משחק',
    joinGame: 'הצטרפות למשחק',
    notesPerPlayer: 'פתקים לכל שחקן',
    skipRule: 'דילוג',
    skipAllowed: 'מותר',
    skipNone: 'אסור',
    ...
    notePlaceholder: 'שם של דמות מוכרת',
    shareWhatsapp: 'שיתוף',
    shareMessage: '📝 בואו לשחק איתי פתקים! קוד: {code}\n{url}',
    editName: '✏️ שינוי שם',
    saveName: 'שמירה',
    cancelEdit: 'ביטול',
    copyCode: '📋 העתקה',
    ...
    submitNote: 'הוספה →',
    submitNoteDone: 'סיום ✓',
    notesDoneTitle: 'סיימתם לכתוב!',
    notesDoneSub: 'מחכים לשאר השחקנים',
    waitingForOthers: 'מחכים לעוד {n} שחקנים...',
    waitingForOthers1: 'מחכים לעוד שחקן אחד...',
    waitingForHost: 'מחכים שמי שפתח את החדר יתחיל...',
    needMorePlayers: 'צריך לפחות {n} שחקנים',
    noteOf: 'פתק',
    of: 'מתוך',
    round: 'סיבוב',
    roundN: 'סיבוב',
    round1name: 'תיאור חופשי',
    round1desc: 'תארו את השם שבפתק בכמה מילים שתרצו.\nרק אסור להגיד את השם עצמו!',
    round2name: 'מילה אחת',
    round2desc: 'מילה אחת בלבד לכל פתק.\nבחרו טוב — אין דרך חזרה!',
    round3name: 'פנטומימה',
    round3desc: 'בלי לדבר ובלי להשמיע קול.\nרק תנועות!',
    startRound: 'מתחילים סיבוב',
    startTurn: '▶ מתחילים תור',
    pauseTurn: '⏸ הפסקה',
    resumeTurn: '▶ ממשיכים',
    paused: 'בהפסקה',
    holdToReveal: 'לחצו והחזיקו כדי לראות',
    correct: '✓ נכון!',
    skip: '↷ דילוג',
    ...
    host: 'מנהל החדר',
    you: 'אתם',
    deckEmpty: 'נחשתם את כל הפתקים!',
    r1short: 'סיבוב 1', r2short: 'סיבוב 2', r3short: 'סיבוב 3',
    total: 'סה"כ',
    enterRoomCode: 'הקלידו קוד',
    enterName: 'הקלידו שם',
    invalidCode: 'הקוד לא תקין — צריך 4 תווים',
    roomNotFound: 'לא מצאנו חדר כזה',
    nameTaken: 'השם הזה תפוס',
    gameStarted: 'המשחק כבר התחיל',
    shareCode: 'שתפו את הקוד:',
    editTeams: '✏️ עריכת קבוצות',
    shuffleTeams: '🔀 ערבוב',
    addTeam: '+ קבוצה',
    removeTeam: '− הסרה',
    doneEditing: 'סיום',
    tapToMove: 'הקישו על שחקן כדי להעביר אותו',
    endGame: 'סיום',
    ...
    waitingToStart: 'מחכים שיתחילו',
    watching: 'צופים',
    isPlaying: 'משחקים עכשיו',
    turnInProgress: 'משחקים עכשיו!',
    yourTurn: 'התור שלכם!',
    notesCount: 'פתקים: {n}',
    createdTheRoom: 'פתחתם חדר!',
    joinedRoom: 'הצטרפתם!',
    settingsLabel: 'הגדרות',
    waitingRoom: 'חדר המתנה',
    teamSetup: 'חלוקה לקבוצות',
    viewOnlyTeamSetup: 'מחלקים אתכם לקבוצות...',
    minTwoPerTeam: 'צריך לפחות 2 שחקנים בכל קבוצה',
    waitingForPlayer: 'מחכים ש-{name} יתחיל...',
    selectTeams: 'בחירת קבוצות',
    dragToMove: 'גררו שחקנים בין הקבוצות',
    editTeamName: 'שם קבוצה',
    changeEmoji: 'החלפת אמוג\'י',
    nextTeam: 'הקבוצה הבאה',
    nextPlayerLabel: 'השחקן',
    moveUp: 'מעלה',
    moveDown: 'מטה',
    yourTurnBig: 'התור שלכם!',
    yourTurnSub: 'תתכוננו — עוד רגע מתחילים',
    randomAssign: 'חלוקה אקראית',
    removeFromTeam: 'הסרה',
    unassignedEmpty: 'כל השחקנים בקבוצות',
  },
  en: {
    back: '← Back',
    leave: '← Leave room',
    ...
    ptakimTitle: 'Ptakim',
    ptakimSubtitle: 'Write names and guess them in 3 rounds',
    ...
    notePlaceholder: 'Someone everyone knows',
    shareWhatsapp: 'Share',
    shareMessage: '📝 Come play Ptakim with me! Code: {code}\n{url}',
    editName: '✏️ Change name',
    saveName: 'Save',
    cancelEdit: 'Cancel',
    copyCode: '📋 Copy',
    copied: 'Copied!',
    submitNote: 'Add →',
    submitNoteDone: 'Done ✓',
    notesDoneTitle: 'All done!',
    notesDoneSub: 'Waiting for everyone else',
    waitingForOthers: 'Waiting for {n} more...',
    waitingForOthers1: 'Waiting for one more...',
    waitingForHost: 'Waiting for the host to start...',
    needMorePlayers: 'You need at least {n} players',
    noteOf: 'Note',
    of: 'of',
    round: 'Round',
    roundN: 'Round',
    round1name: 'Free Description',
    round1desc: 'Use as many words as you like.\nJust don\'t say the name itself!',
    round2name: 'One Word',
    round2desc: 'One word per note, that\'s it.\nChoose well — no take-backs!',
    round3name: 'Pantomime',
    round3desc: 'No talking, no sounds.\nJust act it out!',
    startRound: 'Start Round',
    startTurn: '▶ Start Turn',
    pauseTurn: '⏸ Pause',
    resumeTurn: '▶ Resume',
    paused: 'Paused',
    holdToReveal: 'Hold to peek',
    correct: '✓ Got it!',
    skip: '↷ Skip',
    ...
    host: 'Host',
    you: 'You',
    deckEmpty: 'You got every note!',
    r1short: 'Round 1', r2short: 'Round 2', r3short: 'Round 3',
    total: 'Total',
    enterRoomCode: 'Enter the code',
    enterName: 'Enter your name',
    invalidCode: 'That code needs 4 characters',
    roomNotFound: 'We couldn\'t find that room',
    ...
    ok: 'OK',
    timeUp: 'Time\'s Up!',
    didTeamGuess: 'Did your team get the last word?',
    lastWord: 'Last word',
    guessedIt: 'Got it ✓',
    didNotGuess: 'Missed it ✗',
    ...
    joinedRoom: 'You\'re in!',
    settingsLabel: 'Settings',
    waitingRoom: 'Waiting Room',
    teamSetup: 'Team Setup',
    viewOnlyTeamSetup: 'The host is sorting out teams...',
    minTwoPerTeam: 'At least 2 players per team',
    waitingForPlayer: 'Waiting for {name} to start...',
    selectTeams: 'Pick Teams',
    ...
    unassignedEmpty: 'Everyone has a team',
  },
  es: {
    back: '← Volver',
    leave: '← Salir',
    ...
    ptakimTitle: 'Ptakim',
    ptakimSubtitle: 'Escribe nombres y adivínalos en 3 rondas',
    ...
    notePlaceholder: 'Alguien que todos conozcan',
    shareWhatsapp: 'Compartir',
    shareMessage: '📝 ¡Ven a jugar Ptakim conmigo! Código: {code}\n{url}',
    ...
    notesDoneTitle: '¡Listo!',
    notesDoneSub: 'Esperando a los demás',
    waitingForOthers: 'Faltan {n} jugadores...',
    waitingForOthers1: 'Falta un jugador...',
    waitingForHost: 'Esperando a que empiece el anfitrión...',
    needMorePlayers: 'Hacen falta al menos {n} jugadores',
    noteOf: 'Nota',
    of: 'de',
    round: 'Ronda',
    roundN: 'Ronda',
    round1name: 'Descripción Libre',
    round1desc: 'Usa todas las palabras que quieras.\n¡Solo no digas el nombre!',
    round2name: 'Una Palabra',
    round2desc: 'Una sola palabra por nota.\n¡Elige bien, no hay vuelta atrás!',
    round3name: 'Pantomima',
    round3desc: 'Sin hablar y sin sonidos.\n¡Solo gestos!',
    startRound: 'Empezar Ronda',
    startTurn: '▶ Empezar Turno',
    pauseTurn: '⏸ Pausa',
    resumeTurn: '▶ Seguir',
    paused: 'En pausa',
    holdToReveal: 'Mantén pulsado para ver',
    correct: '✓ ¡Sí!',
    skip: '↷ Pasar',
    ...
    host: 'Anfitrión',
    you: 'Tú',
    deckEmpty: '¡Acertaron todas las notas!',
    r1short: 'Ronda 1', r2short: 'Ronda 2', r3short: 'Ronda 3',
    total: 'Total',
    enterRoomCode: 'Escribe el código',
    enterName: 'Escribe tu nombre',
    invalidCode: 'El código lleva 4 caracteres',
    roomNotFound: 'No encontramos esa sala',
    nameTaken: 'Ese nombre ya está en uso',
    gameStarted: 'Este juego ya empezó',
    ...
    didTeamGuess: '¿Tu equipo acertó la última palabra?',
    ...
    joinedRoom: '¡Ya estás dentro!',
    settingsLabel: 'Ajustes',
    waitingRoom: 'Sala de Espera',
    teamSetup: 'Armar Equipos',
    viewOnlyTeamSetup: 'El anfitrión está armando los equipos...',
    minTwoPerTeam: 'Al menos 2 jugadores por equipo',
    ...
    unassignedEmpty: 'Todos tienen equipo',
  }
};
    ...
    if (allDone) {
      ...
      footerHtml = `
        <div class="ptk-waiting-note">
          ⏳ ${missingNotes === 1 ? t('waitingForOthers1') : t('waitingForOthers', { n: missingNotes })}
        </div>
      `;
    }
  } else {
    ...
    <div class="ptk-screen">
      <div class="ptk-inner" style="justify-content:center;text-align:center;padding-top:32px;">
        ...
        <div style="font-size:0.85rem;color:var(--text-dim);">
          ${P.room.noteCount || P.room.notes.length} ${t((P.room.noteCount || P.room.notes.length) === 1 ? 'notes1' : 'notes')}
        </div>
...
function renderPtakimPlaying(app) {
  ...
  if (!active) {
    ...
    ` : `
      ...
      <div class="ptk-deck-count">${notesRemaining} ${t(notesRemaining === 1 ? 'notes1' : 'notes')}</div>
